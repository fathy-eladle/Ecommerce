...
from .views import RegisterView, VerifyAccountView,ResendCodeView,CheckUserStatus,ResetPasswordRequestView,ResetPasswordConfirmView,ResendPasswordCodeView,ChangePasswordView,LogoutView,UpdateProfileView,CustomTokenObtainPairView
